...
BinarySearchTree.prototype.createSimilar = function (options) {
  ...
  options.notifyChanges = this.notifyChanges;
...
BinarySearchTree.prototype.listAll = function (l) {
  if(!l) {
    l = [];
    this.listAll(l);
    return l;
  ...
  if(!this.hasOwnProperty('key')) return;
  if(this.left) this.left.listAll(l);
  l.push({
    key: this.key,
    value: this.data
  })
  if(this.right) this.right.listAll(l);
};
...
BinarySearchTree.prototype.search = function (key) {
  ...
  if (this.compareKeys(this.key, key) === 0) {
    return {
      node: this.data,
      parent: (this.parent ? this.parent.data : undefined)
    };
  }
