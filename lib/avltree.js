...
function _AVLTree (options) {
  ...
  this.notifyChanges = options.notifyChanges;
}
...
_AVLTree.prototype.delete = function (key, value) {
  ...
  if (!currentNode.left || !currentNode.right) {
    ...
    if (currentNode === this) {   // This node is also the root
      ...
      currentNode.notifyChanges({
        ...
        key: currentNode.parent.key,
        value: currentNode.parent.data
      });
      if (currentNode.parent.left === currentNode) {
  ...
  if (!replaceWith.right) {
    currentNode.notifyChanges({
      ...
      key: currentNode.parent.key,
      value: currentNode.parent.value
    } : undefined));
    currentNode.notifyChanges({
      key: currentNode.right.key,
  ...
  if (replaceWith.left) {
    currentNode.notifyChanges({
      key: replaceWith.left.key,
      value: replaceWith.left.value
    }, {
      key: replaceWith.parent.key,
      value: replaceWith.parent.value
    })
 ...
 */
['getNumberOfKeys', 'listAll', 'search', 'betweenBounds', 'prettyPrint', 'executeOnEveryNode'].forEach(function (fn) {
